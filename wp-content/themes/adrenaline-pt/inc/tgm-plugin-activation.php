 ...
 */
function adrenaline_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'Custom Sidebars by ProteusThemes',
			'slug'               => 'custom-sidebars-by-proteusthemes',
			'required'           => true,
		),
		array(
...
add_action( 'tgmpa_register', 'adrenaline_register_required_plugins' );
