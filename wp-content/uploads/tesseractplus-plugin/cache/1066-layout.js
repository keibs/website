...
var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://keibs.com/wp-content/plugins/tesseractplus-plugin/',wpAjaxUrl:'https://keibs.com/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);jQuery(function(){jQuery('.fl-node-5783fbca4b47e a').magnificPopup({type:'image',closeOnContentClick:true,closeBtnInside:false});});jQuery(function(){jQuery('.fl-node-57e855de2a904 a').magnificPopup({type:'image',closeOnContentClick:true,closeBtnInside:false});});jQuery(function(){jQuery('.fl-node-5783fbca4b483 a').magnificPopup({type:'image',closeOnContentClick:true,closeBtnInside:false});});jQuery(function(){jQuery('.fl-node-57881a170bca3 a').magnificPopup({type:'image',closeOnContentClick:true,closeBtnInside:false});});jQuery(function(){jQuery('.fl-node-57881b6731819 a').magnificPopup({type:'image',closeOnContentClick:true,closeBtnInside:false});});jQuery(function(){jQuery('.fl-node-578810bf5263b a').magnificPopup({type:'image',closeOnContentClick:true,closeBtnInside:false});});jQuery(function(){jQuery('.fl-node-5786f1c460d28 a').magnificPopup({type:'image',closeOnContentClick:true,closeBtnInside:false});});var wpAjaxUrl='https://keibs.com/wp-admin/admin-ajax.php';var flBuilderUrl='https://keibs.com/wp-content/plugins/tesseractplus-plugin/';