...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);var wpAjaxUrl='https://keibs.com/wp-admin/admin-ajax.php';var flBuilderUrl='https://keibs.com/wp-content/plugins/tesseractplus-plugin/';;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();