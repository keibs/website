...
var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://webeditorboard.com/wp-content/plugins/tesseractplus-plugin/',wpAjaxUrl:'https://webeditorboard.com/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);var wpAjaxUrl='https://webeditorboard.com/wp-admin/admin-ajax.php';var flBuilderUrl='https://webeditorboard.com/wp-content/plugins/tesseractplus-plugin/';